...
public class FilmData {
    private static String[][] data = new String[][]{
            ...
            {"Spider-Man: Into the Spider-Verse","Miles Morales is juggling his life between being a high school student and being a spider-man. When Wilson \"Kingpin\" Fisk uses a super collider, others from across the Spider-Verse are transported to this dimension.","https://image.tmdb.org/t/p/w600_and_h900_bestv2/iiZZdoQBEYBv6id8su7ImL0oCbD.jpg","ACTION, ADVENTURE, ANIMATION","English","1h 57m","$90,000,000.00","$375,450,417.00","8.5","2018","Bob Persichetti, Peter Ramsey","Shameik Moore, Jake Johnson"},
            ...
            {"Alita: Battle Angel ","When Alita awakens with no memory of who she is in a future world she does not recognize, she is taken in by Ido, a compassionate doctor who realizes that somewhere in this abandoned cyborg shell is the heart and soul of a young woman with an extraordinary past.","https://image.tmdb.org/t/p/w600_and_h900_bestv2/xRWht48C2V8XNfzvPehyClOvDni.jpg","ACTION, SCIENCE FICTION, THRILLER","English","2h 2m","$170,000,000.00","$404,852,543.00","7.5","2019","Robert Rodriguez","Rosa Salazar, Christoph Waltz"},
